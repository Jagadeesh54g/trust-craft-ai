...
export const ProfileUpload = ({ type, children }: ProfileUploadProps) => {
  ...
  const { addExperience, addSkill, addProject, addCertificate } = useProfile();
    ...
    switch (type) {
      ...
      case 'skill':
        addSkill({
          ...
          description: formData.get('skillDescription') as string,
        });
        break;
      ...
      case 'project':
        addProject({
          ...
          liveUrl: formData.get('projectUrl') as string,
          githubUrl: formData.get('githubUrl') as string,
        });
        break;
        
      case 'certificate':
        const certFile = formData.get('certFile') as File;
        addCertificate({
          name: formData.get('certName') as string,
          issuer: formData.get('issuer') as string,
          issueDate: formData.get('issueDate') as string,
          credentialId: formData.get('credentialId') as string,
          file: certFile?.size > 0 ? certFile : undefined,
        });
        break;
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input id="jobTitle" name="jobTitle" placeholder="e.g. Senior Developer" required />
              </div>
              <div>
            ...
            <div>
              ...
              <Textarea id="description" name="description" placeholder="Describe your role and achievements..." rows={4} />
            </div>
        ...
        return (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <Input id="skillName" name="skillName" placeholder="e.g. React, Python, Design" required />
            </div>
            <div>
              <Label htmlFor="skillLevel">Proficiency Level</Label>
              <select name="skillLevel" className="w-full p-2 border rounded-md bg-background">
            ...
            <div>
              ...
              <Textarea id="skillDescription" name="skillDescription" placeholder="Work experience, courses, projects..." rows={3} />
            </div>
            <Button type="submit" className="w-full">
              <Save className="w-4 h-4 mr-2" />
              Add Skill
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input id="projectUrl" name="projectUrl" type="url" placeholder="https://example.com" />
              </div>
              <div>
                <Label htmlFor="githubUrl">GitHub URL (optional)</Label>
                <Input id="githubUrl" name="githubUrl" type="url" placeholder="https://github.com/user/repo" />
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <Textarea id="projectDescription" name="projectDescription" placeholder="Describe what the project does and your role..." rows={4} required />
            </div>
            <Button type="submit" className="w-full">
              <Save className="w-4 h-4 mr-2" />
              Save Project
        ...
        return (
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <Input id="certName" name="certName" placeholder="e.g. AWS Certified Developer" required />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
            ...
            <div>
              ...
              <Input id="credentialId" name="credentialId" placeholder="Certificate ID or URL" />
            </div>
            <div>
              ...
              <div className="border-2 border-dashed border-muted-foreground/20 rounded-lg p-4 text-center">
                ...
                <Input type="file" name="certFile" accept=".pdf,.jpg,.jpeg,.png" className="hidden" id="certFile" />
